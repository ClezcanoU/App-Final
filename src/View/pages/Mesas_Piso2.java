...
public class Mesas_Piso2 extends javax.swing.JPanel implements MesaListener{
    ...
    private void init(){
        ...
        cardMesa2.setDatos(new Mesa("Mesa #11","#11",Mesa.Estado.LIBRE,Icon,"","",""));
        ...
        cardMesa5.setDatos(new Mesa("Mesa #14","#14",Mesa.Estado.LIBRE,Icon,"","",""));
        cardMesa6.setDatos(new Mesa("Mesa #15","#15",Mesa.Estado.LIBRE,Icon,"","",""));
        cardMesa7.setDatos(new Mesa("Mesa #16","#16",Mesa.Estado.MANTENIMIENTO,Icon,"","",""));
        cardMesa8.setDatos(new Mesa("Mesa #17","#17",Mesa.Estado.LIBRE,Icon,"","",""));
